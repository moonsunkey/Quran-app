...
const SURAHS = [
  ...
  { id:'al-rahman', number:55, name:'Al-Rahman', arabic:'الرحمان', meaning:'The Most Merciful',    ayahs:78,  difficulty:'Beginner',     status:'coming-soon', color:'#E67E22', description:'The "beauty of the Quran" — features the iconic repeating refrain about Allah\'s blessings.' },
