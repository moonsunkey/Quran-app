...
const SURAHS = [
  ...
  { id:'al-qadr',    number:97,  name:'Al-Qadr',    arabic:'القدر',    meaning:'The Night of Decree',   ayahs:5,   difficulty:'Beginner', status:'available', color:'#9B59B6', description:'The night better than a thousand months — when the Quran was first revealed.' },
  { id:'al-masad',   number:111, name:'Al-Masad',   arabic:'المسد',    meaning:'The Palm Fibre',        ayahs:5,   difficulty:'Beginner', status:'available', color:'#C0504D', description:'A warning to those who oppose the truth — five powerful ayahs.' },
  { id:'ash-sharh',  number:94,  name:'Ash-Sharh',  arabic:'الشرح',    meaning:'The Relief',            ayahs:8,   difficulty:'Beginner', status:'available', color:'#4CAF8A', description:'With every hardship comes ease — a message of hope and relief.' },
  { id:'at-tin',     number:95,  name:'At-Tin',     arabic:'التين',    meaning:'The Fig',               ayahs:8,   difficulty:'Beginner', status:'available', color:'#E67E22', description:'Mankind created in the best form — and those who believe will have the greatest reward.' },
  { id:'al-alaq',    number:96,  name:'Al-Alaq',    arabic:'العلق',    meaning:'The Clot',              ayahs:19,  difficulty:'Beginner', status:'available', color:'#D4A843', description:'The first revelation — Read! In the name of your Lord who created.' },
  { id:'ad-duha',    number:93,  name:'Ad-Duha',    arabic:'الضحى',    meaning:'The Morning Hours',     ayahs:11,  difficulty:'Beginner', status:'available', color:'#E67E22', description:'Your Lord has not abandoned you — comfort for the Prophet and all believers.' },
  { id:'al-layl',    number:92,  name:'Al-Layl',    arabic:'الليل',    meaning:'The Night',             ayahs:21,  difficulty:'Beginner', status:'available', color:'#5B8FD4', description:'Two paths — generosity and faith lead to ease, miserliness to hardship.' },
  { id:'ash-shams',  number:91,  name:'Ash-Shams',  arabic:'الشمس',    meaning:'The Sun',               ayahs:15,  difficulty:'Beginner', status:'available', color:'#2ECC71', description:'The soul and its purification — eleven oaths leading to one truth.' },
