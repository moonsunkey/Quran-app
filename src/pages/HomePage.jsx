...
const SURAHS = [
  ...
  { id:'al-asr',     number:103, name:'Al-Asr',     arabic:'الْعَصْر',      meaning:'The Time',             ayahs:3,   difficulty:'Beginner',     status:'available',   color:'#F57C00', description:'Three verses that contain the complete formula for human success — faith, deeds, truth, and patience. All four are required.' },
